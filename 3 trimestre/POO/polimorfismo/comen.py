...
t.datos() #Invoca el metodo datos para que imprima el tipo de vehiculo y el proposito del vehiculo
print(t.__str__()) #Muestra el retorno de la funcion __str__ dependiendo de cual este primero en la subclase Terrestre
